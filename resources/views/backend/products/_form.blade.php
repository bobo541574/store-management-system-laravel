...
<div class="row">
    ...
    {{-- <div class="col-md-2">
        <div class="form-group">
            ...
            <input id="arrived" type="date" class="form-control form-control-sm @error('arrived') is-invalid @enderror" name="arrived"
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <input id="product_code" type="search" class="form-control form-control-sm @error('product_code') is-invalid @enderror" name="product_code"
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <select name="supplier" id="supplier" class="custom-select custom-select-sm @error('supplier') is-invalid @enderror"
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select name="subcategory" id="subcategory" class="custom-select custom-select-sm @error('subcategory') is-invalid @enderror"
                ...
                <option value="{{ $subcategory->id }}" {{ ($subcategory->id == ($product->subcategory_id ?? old('subcategory'))) ? 'selected' : '' }}>
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select name="brand" id="brand" class="custom-select custom-select-sm @error('brand') is-invalid @enderror"
