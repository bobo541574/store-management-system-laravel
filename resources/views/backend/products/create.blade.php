...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        (index > 0) ? console.log('empty'): addProduct(index);
        ...
        remove.addEventListener('click', () => {
            if(index == 0) {
                ...
                let product_node = document.querySelector(`#product_node_${index}`);
                product_node.remove();
                index--;
                btnRemove.id = `btn_remove_${index}`;
            }
        ...
        function addProduct(index) {
            ...
            product ? product.appendChild(row) : '';
        ...
        photo ? photo.addEventListener('change', function () {
            ...
            for (let i = 0; i < images.length; i++) {
                ...
                reader.onload = () => {
                    ...
                    parent.innerHTML += `<input type="hidden" name="row[${index}][images][${result}][${i}]">`;
