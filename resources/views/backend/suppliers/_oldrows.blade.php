                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select id="city_{{ $key }}" name="row[{{ $key }}][city]" disabled
                            ...
                            class="custom-select custom-select-sm haha {{ $errors->has("row.$key.city") ? 'is-invalid' : '' }}"
                            value="{{ $value['city'] ?? '' }}" data-id="{{ $value['city'] ?? '' }}" onclick="selectCity({{$key}})" autocomplete="off">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select id="township_{{ $key }}" name="row[{{ $key }}][township]" disabled
                            ...
                            value="{{ $value['township'] ?? '' }}" data-id="{{ $value['township'] ?? '' }}" onclick="selectTownship({{$key}})" autocomplete="off">
